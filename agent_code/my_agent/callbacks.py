...
def extract_state(self,old_game_state):
    ...
    # free
        ...
        # Expect: DOWN
            ...
            state = [10,6]
        # Expect: LEFT OR UP OR DOWN OR RIGHT
        ...
        # Expect: DOWN
            ...
            state = [10,14]
        # Expect: RIGHT OR LEFT OR UP OR DOWN
        ...
        # Expect: DOWN
            ...
            state = [10,22]
        # Expect: RIGHT OR UP OR DOWN OR LEFT 
