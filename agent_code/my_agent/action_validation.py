...
validation_array[2,2] = 2#,3
validation_array[2,3] = 2#,3]
...
validation_array[3,2] = 0#,3
validation_array[3,3] = 0#,3]
...
validation_array[6,3] = 0#,3]
validation_array[6,4] = 1
validation_array[6,5] = 0
validation_array[6,6] = 2
validation_array[6,7] = 0
validation_array[6,8] = 2
validation_array[6,9] = 0
...
validation_array[7,3] = 0#,3]
validation_array[7,4] = 3
validation_array[7,5] = 0
validation_array[7,6] = 2
validation_array[7,7] = 0
validation_array[7,8] = 2
validation_array[7,9] = 2
...
validation_array[8,3] = 1#,3]
validation_array[8,4] = 3
validation_array[8,5] = 1
validation_array[8,6] = 2
validation_array[8,7] = 1
validation_array[8,8] = 2
validation_array[8,9] = 2
...
validation_array[9,3] = 1#,3]
validation_array[9,4] = 3
validation_array[9,5] = 1
validation_array[9,6] = 0
validation_array[9,7] = 3
validation_array[9,8] = 0
validation_array[9,9] = 2
...
for x in range(10):
    print(" ")
    for y in range(13):
        if np.argmax(policy[x,y]) == validation_array[x,y]:
